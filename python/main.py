...
dftosql.insert_data_sql('idealista', 'clientes', clientesdf, ['Edad','Transporte Público','Colegios', 'Zonas Verdes', 'Centros Sanitarios', 'Contaminación', 'Ruido', 'Limpieza', 'Eléctrico'])
