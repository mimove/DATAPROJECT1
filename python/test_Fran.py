...
# ASIGNAMOS UNA PUNTACION AL NIVEL DE CALIDAD AMBIENTAL PARA CADA BARRIO
...
barrios_caracteristicas['punt_ambiental'] = punt_ambiental 

print(barrios_caracteristicas[['calidad_ambiental','punt_ambiental']])
